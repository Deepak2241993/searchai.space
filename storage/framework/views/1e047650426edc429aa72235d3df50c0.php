...
<aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
    <div class="sidebar-brand"> <!--begin::Brand Link--> <a href="<?php echo e(route('home')); ?>" class="brand-link"> <!--begin::Brand Image--> <img src="<?php echo e(url('/front-assets/images/footer_logo.png')); ?>" alt="search ai logo" class="brand-image opacity-75 shadow"> <span class="brand-text fw-light"></span> </a> </div>
