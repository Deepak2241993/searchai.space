...
<aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
    <div class="sidebar-brand"> <!--begin::Brand Link--> <a href="<?php echo e(route('home')); ?>" class="brand-link"> <!--begin::Brand Image--> <img src="<?php echo e(url('/front-assets/images/logo.png')); ?>" alt="search ai logo" class="brand-image opacity-75 shadow"> <span class="brand-text fw-light"></span> </a> </div>
    <div class="sidebar-wrapper">
        <nav class="mt-2"> <!--begin::Sidebar Menu-->
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('token.index')); ?>" class="nav-link <?php echo e(Request::segment(1) === 'token-views' ? 'active' : ''); ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('ccrv-and-background-verification')); ?>" class="nav-link <?php echo e(Request::segment(1) === 'ccrv-and-background-verification' ? 'active' : ''); ?>">
                        <i class="nav-icon fa fa-check-square-o" aria-hidden="true"></i>
...
</aside> <!--end::Sidebar--><?php /**PATH /home/gbalz51c0wat/public_html/searchai.space/resources/views/components/admin/sidebar.blade.php ENDPATH**/ ?>