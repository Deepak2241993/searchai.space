...
<body>
    <div class="email-container">
        ...
        <div class="email-header">
            <img src="<?php echo e(url('/front-assets/images/footer_logo.png')); ?>" alt="SearchAI">
        ...
        <div class="email-body">
            ...
            <a href="<?php echo e(url('/login')); ?>" class="cta-button">Log In</a>
            <p>Thank you,</p>
        ...
        <div class="email-footer">
            ...
            <p>&copy; <?php echo e(date('Y')); ?> SearchAI. All rights reserved.</p>
        </div>
    </div>
</body>
</html>
<?php /**PATH /home/gbalz51c0wat/public_html/searchai.space/resources/views/emails/registration.blade.php ENDPATH**/ ?>