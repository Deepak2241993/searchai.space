    ...
    <div class="login-box">        
        <div class="card">
            <div class="login-logo mt-4">
                <a href="#">
                    <img src="<?php echo e(url('/front-assets/assets/img/finallogo.png')); ?>" width="80%" alt="Search AI Admin Logo" />
                </a>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\searchai.space\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>