        ...
        <div class="card">
            <div class="card-body login-card-body">
                <div class="login-logo">
                    <a href="#">
                        <img src="<?php echo e(url('/')); ?>/front-assets/images/footer_logo.png" width="80%" alt="Search AI Logo" />
                    </a>
                </div>
                ...
                <div class="col-12 mt-4 text-center">
                    <p class="mb-3">
                        <a href="<?php echo e(route('password.request')); ?>" class="text-decoration-none text-primary fw-bold" style="font-size: 1.1rem;">
                            <i class="fas fa-key me-1"></i> Forgot Password?
                        </a>
                    </p>
                    <p class="mb-0 mt-2">
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-outline-primary btn-sm px-4 py-2 rounded-pill shadow-sm">
...
</html><?php /**PATH /home/gbalz51c0wat/public_html/searchai.space/resources/views/auth/login.blade.php ENDPATH**/ ?>