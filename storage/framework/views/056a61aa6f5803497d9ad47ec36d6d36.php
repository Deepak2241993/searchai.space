                        ...
                        <div class="row align-center">
                            <div class="col-xl-6 col-lg-7 col-md-10">
                                <div class="content">
                                    ...
                                    <h2>Aadhar Card Verification – Instant & Secure Identity Check</h2>
                                    <p>
                                        Quick & Reliable Background Verification!Get Aadhar, PAN, Criminal, 
                                        and Police Verification done seamlessly with fast & accurate screening. 
                                        Trust us for secure hiring!
                                    </p>
                                    <div class="button">
                        ...
                        <div class="row align-center">
                            <div class="col-xl-6 col-lg-7 col-md-10">
                                <div class="content">
                                    ...
                                    <h2>PAN Card Verification – Quick & Accurate Identity Validation</h2>
                                    <p>
                                        PAN Card Verification – Ensure quick and accurate identity validation 
                    ...
                    <div class="container">
                        <div class="row align-center">
                            <div class="col-xl-6 col-lg-7 col-md-10">
                                <div class="content">
                                    <!-- <h4>Coaching & Consulting</h4> -->
                                    <h2>Police Verification – Authentic & Compliant Screening</h2>
                                    <p>
                                        Police Verification – Get authentic and compliant screening to 
                                    ...
                                    <div class="accordion" id="faqAccordion1">
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapseOne1" class="accordion-collapse collapse show" aria-labelledby="headingOne1" data-bs-parent="#faqAccordion1">
                                                <div class="accordion-body">
                                                    <p>It is an Easier, Simpler & Better way of verifying Workers. 5 minutes and just a click of a few buttons, that’s all it takes to verify Workers at SearchAI.</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapseTwo1" class="accordion-collapse collapse" aria-labelledby="headingTwo1" data-bs-parent="#faqAccordion1">
                                                <div class="accordion-body">
                                                    <p>SearchAI follows a 2/3 Step Verification Process for every Worker registered with the platform. Everyone’s IDs & Court/Criminal Records are checked in detail.</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapseThree1" class="accordion-collapse collapse" aria-labelledby="headingThree1" data-bs-parent="#faqAccordion1">
                                                <div class="accordion-body">
                                                    <p>Get the Background Verification report in about 10-15 minutes.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="accordion" id="faqAccordion2">
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapseFour2" class="accordion-collapse collapse show" aria-labelledby="headingFour2" data-bs-parent="#faqAccordion2">
                                                <div class="accordion-body">
                                                    <p>Get the detailed Background Verification report directly in your email inbox. You are not required to go anywhere for the checks or submit a document anywhere. The whole process is hasslefree and online - end to end.</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapseFive2" class="accordion-collapse collapse" aria-labelledby="headingFive2" data-bs-parent="#faqAccordion2">
                                                <div class="accordion-body">
                                                    <p>Get the professional background verification of your workers done in as low as ₹300 only.</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapseSix2" class="accordion-collapse collapse" aria-labelledby="headingSix2" data-bs-parent="#faqAccordion2">
                                                <div class="accordion-body">
                                                    <p>Every transaction processed at SearchAI goes through the recognised payment gateways like Paytm, PayU & others. Your details are entirely secured & protected against any unauthorised transactions.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\searchai.space\resources\views/layouts/front.blade.php ENDPATH**/ ?>