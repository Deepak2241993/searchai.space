        ...
        <div class="success-content">
            <div class="order-details">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">#<?php echo e($order_id); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Payment Transaction Id</span>
                    <span class="detail-value">#<?php echo e($paymentId); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Transaction Amount</span>
                    <span class="detail-value">₹<?php echo e($amount); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Date</span>
                    <span class="detail-value"><?php echo e(\Carbon\Carbon::createFromTimestamp($createdAt)->format('d M Y, h:i A')); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Status</span>
                    <span class="detail-value" style="color: #4caf50;">
                        <?php echo e(ucfirst($status === 'success' ? 'Completed' : $status)); ?>
            ...
            <div class="action-buttons">
                ...
                <a href="<?php echo e(route('dashboard')); ?>" class="secondary-btn">Return to Dashboard</a>
            </div>
        </div>
    </div>
</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\searchai.space\resources\views/payment/success.blade.php ENDPATH**/ ?>