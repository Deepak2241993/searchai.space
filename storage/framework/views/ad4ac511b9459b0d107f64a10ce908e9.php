                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button class="btn btn-sm btn-primary view-data-btn"
                                                ...
                                                data-token="<?php echo e($Token->token); ?>"
                                                data-service="<?php echo e($Token->service_type); ?>"
                                                data-aadhaar="<?php echo e(json_encode($Token->aadhaarData)); ?>">
                                                View
                                            </button>
                                            <a href="<?php echo e(route('download.pdf', $Token->id)); ?>" class="btn btn-sm btn-secondary">
                                                Download PDF
                                            </a>
                                        </td>
                                        <?php endif; ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="aadhaarOtpForm" action="<?php echo e(route('aadhaar.generate')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gbalz51c0wat/public_html/searchai.space/resources/views/token/index.blade.php ENDPATH**/ ?>