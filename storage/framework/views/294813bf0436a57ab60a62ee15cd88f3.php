            ...
            <div class="carousel-item <?php echo e($key == 0 ? 'active' : ''); ?>">
                ...
                <div class="carousel-caption">
                    <div class="carousel-content">
                        <h4 class="banner-title"><?php echo $banner->title; ?></h4>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="ServiceButton">
                        <?php $__currentLoopData = $serviceData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('services.show', $item->service_slug)); ?>" class="w-100">
                                <button class="btn-submit">
                                    <?php echo e('Buy'); ?> <?php echo e($item->name == 'KYC+CCRV' ? 'Aadhar KYC + Criminal Background Verification' : $item->name); ?>
    ...
    <div class="d-none d-md-block">
      <div class="d-flex justify-content-center align-items-center gap-4">
        ...
        <div class="d-flex align-items-center gap-4">
          <img src="<?php echo e(url('/front-assets/images/add-user.png')); ?>" alt="Add User" class="process-icon">
          <span class="mt-2">Register Yourself</span>
          <i class="bi bi-arrow-right fs-3"></i>
          
          <img src="<?php echo e(url('/front-assets/images/fingerprint.png')); ?>" alt="Fingerprint" class="process-icon">
          <span class="mt-2">Verify Yourself</span>
          <i class="bi bi-arrow-right fs-3"></i>
          
          <img src="<?php echo e(url('/front-assets/images/download.png')); ?>" alt="Download" class="process-icon">
...
<section class="container">
    ...
    <div class="d-flex align-items-center mb-4">
      <img src="<?php echo e(url('/front-assets/images/legal-document.png')); ?>" alt="icon" style="width: 60px; height: 60px;">
    ...
    <div class="row g-4">
      ...
      <div class="col-md-6">
        <div class="d-flex align-items-center p-3 rounded-3 shadow-sm" style="border-style: groove;">
          <img src="<?php echo e(url('/front-assets/images/aadhar.jpg')); ?>" alt="Aadhaar Card" style="width: 60px; height: 60px;" />
          <div class="ms-3">
      ...
      <div class="col-md-6">
        <div class="d-flex align-items-center p-3 rounded-3 shadow-sm" style="border-style: groove;">
          <img src="<?php echo e(url('/front-assets/images/pancard.png')); ?>" alt="PAN Card" style="width: 60px; height: 60px;" />
          <div class="ms-3">
      ...
      <div class="col-md-6">
        <div class="d-flex align-items-center p-3 rounded-3 shadow-sm" style="border-style: groove;">
          <img src="<?php echo e(url('/front-assets/images/dl.webp')); ?>" alt="Driving License" style="width: 60px; height: 60px;" />
          <div class="ms-3">
      ...
      <div class="col-md-6">
        <div class="d-flex align-items-center p-3 rounded-3 shadow-sm" style="border-style: groove;">
          <img src="<?php echo e(url('/front-assets/images/rc.webp')); ?>" alt="Vehicle Registration" style="width: 60px; height: 60px;" />
          <div class="ms-3">
    ...
    <section id="about-us">
        ...
        <div class="container">
            ...
            <div class="text-center block m3">
                ...
                <a href="<?php echo e(route('aboutus')); ?>" class="btn btn-warning text-white fw-bold mt-3 px-4">READ MORE&nbsp;<i class="fa fa-arrow-circle-right"></i></a>
