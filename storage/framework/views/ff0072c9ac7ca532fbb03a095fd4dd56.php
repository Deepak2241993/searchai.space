<footer id="footer">
	  ...
	  <div class="container">
		<nav style="width:100%" class="ampstart-footer-nav">
			...
			<div class="sm-col-12 md-col-3 md-col lg-col lg-col-3">
				...
				<ul class="list-reset footer-links mb2"> 
					<li><a href="<?php echo e(route('aboutus')); ?>" class="inline-block footer-link text-decoration-none">About Us</a></li>
			...
			<div class="sm-col-12 md-col-2 md-col lg-col lg-col-2 text-center">
				<amp-img layout="fixed" width="190" height="50" src="<?php echo e(url('/front-assets/footer_logo-removebg-preview.png')); ?>" alt="Helpers near me"></amp-img>
			</div>
		</nav>
	  </div>	
	</div>
	<div style="background:#2e2d2d;color:#fff;padding:1px 0px 1px" class="copyright">
		...
		<h5 class="text-center">Copyright &copy; <?php echo e(date('Y')); ?> Navigant Digital Pvt ltd. |  All rights reserved | <a href="https://www.thetemz.com/" target="_blank">Develop by TEMZ</a></h5>
	</div>
</footer><?php /**PATH /home/gbalz51c0wat/public_html/searchai.space/resources/views/components/front/footer.blade.php ENDPATH**/ ?>