...
@section('main-body')
              ...
              <div class="row">
                  <div class="col-12 services-single-content">
                      <div class="faq-style-one service-faq mt-40">
                          ...
                          @foreach($chunkedFaqs as $colIndex => $columnFaqs)
                              <div class="col-md-6">
                                  <div class="accordion" id="faqAccordion{{ $colIndex + 1 }}">
                                      @foreach($columnFaqs as $faqIndex => $faq)
                                          @php
                                          ...
                                          <div class="accordion-item">
                                              <h2 class="accordion-header" id="{{ $headingId }}">
                                                  <button class="accordion-button @if(!$isFirst) collapsed @endif"
                                                          type="button"
                                              ...
                                              <div id="{{ $collapseId }}"
                                                   ...
                                                   data-bs-parent="#faqAccordion{{ $colIndex + 1 }}">
  ...
  <div class="project-deal-area text-center default-padding bg-gray">
      <div class="deal-illustration">
          <img src="{{url('/front-assets')}}/assets/img/illustration/8.png" alt="Image Not Found">
      </div>
      <div class="arrow-illustration">
          <img src="{{url('/front-assets')}}/assets/img/illustration/9.png" alt="Image Not Found">
      </div>
      <div class="container">
          <div class="row">
              <div class="col-lg-8 offset-lg-2">
                  <div class="project-deal">
                      ...
                      <form class="newsletter-form mt-30" action="{{route('newsletter.store')}}" method="post">
                        @csrf
...
<div class="case-studies-area default-padding" style="background-image: url({{url('/front-assets')}}/assets/img/shape/30.png);">
  ...
  <!-- Start Contact Us 
  ============================================= -->
  <div class="contact-area overflow-hidden default-padding" style="background-image: url({{url('/front-assets')}}/assets/img/shape/map.png);">
      <div class="shape-right-bottom">
          <img src="{{url('/front-assets')}}/assets/img/shape/18.png" alt="Shape">
      </div>
      <div class="container">
          <div class="row align-center">
